...
{runtimeScene.getVariables().get("typeRate").setNumber(30.075);
    ...
    gdjs.IntroCode.GDTypingTextObjects2[i].returnVariable(gdjs.IntroCode.GDTypingTextObjects2[i].getVariables().getFromIndex(0)).setString((gdjs.IntroCode.GDTypingTextObjects2[i].getString()));
}
}{for(var i = 0, len = gdjs.IntroCode.GDTypingTextObjects2.length ;i < len;++i) {
...
};gdjs.IntroCode.mapOfGDgdjs_46IntroCode_46GDplayObjects1Objects = Hashtable.newFrom({"play": gdjs.IntroCode.GDplayObjects1});gdjs.IntroCode.eventsList5 = function(runtimeScene) {
...
};gdjs.IntroCode.mapOfGDgdjs_46IntroCode_46GDplayObjects1Objects = Hashtable.newFrom({"play": gdjs.IntroCode.GDplayObjects1});gdjs.IntroCode.eventsList6 = function(runtimeScene) {
...
{
{gdjs.IntroCode.conditionTrue_1 = gdjs.IntroCode.condition0IsTrue_0;
gdjs.IntroCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8909516);
}
}if ( gdjs.IntroCode.condition0IsTrue_0.val ) {
{
