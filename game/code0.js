...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11215132);
}
}}
...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11218900);
}
}if (gdjs.MainMenuCode.condition0IsTrue_0.val) {
