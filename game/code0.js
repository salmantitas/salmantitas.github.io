...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11735588);
}
}}
...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11739060);
}
}if (gdjs.MainMenuCode.condition0IsTrue_0.val) {
