...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13047196);
}
}}
...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13050668);
}
}if (gdjs.MainMenuCode.condition0IsTrue_0.val) {
