...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11742084);
}
}}
...
gdjs.MainMenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11745556);
}
}if (gdjs.MainMenuCode.condition0IsTrue_0.val) {
